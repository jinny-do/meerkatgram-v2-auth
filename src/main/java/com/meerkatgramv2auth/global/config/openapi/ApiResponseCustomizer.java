...
public class ApiResponseCustomizer implements OperationCustomizer {
    ...
    public Operation customize(Operation operation, HandlerMethod handlerMethod) {
        com.meerkatgramv2auth.global.config.openapi.CustomApiResponse annotation = handlerMethod.getMethodAnnotation(com.meerkatgramv2auth.global.config.openapi.CustomApiResponse.class);
        if (annotation == null) {
            return operation;
        }
